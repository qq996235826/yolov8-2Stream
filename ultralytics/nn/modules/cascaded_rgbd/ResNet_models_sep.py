...
import numpy as np
from ultralytics.nn.modules.cascaded_rgbd.ResNet import B2_ResNet

device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
from torch.autograd import Variable
from torch.nn import Parameter, Softmax
from torch.distributions import Normal, Independent, kl
from ultralytics.nn.modules.cascaded_rgbd.HolisticAttention import HA

CE = torch.nn.BCELoss(reduction='sum')
cos_sim = torch.nn.CosineSimilarity(dim=1, eps=1e-8)
from ultralytics.nn.modules.cascaded_rgbd.batchrenorm import BatchRenorm2d
