...
class AutoBackend(nn.Module):
    ...
    def forward(self, im,im_depth, augment=False, visualize=False):
        """
        ...
        if self.pt or self.nn_module:  # PyTorch
            y = self.model([im,im_depth], augment=augment, visualize=visualize) if augment or visualize else self.model([im,im_depth])
