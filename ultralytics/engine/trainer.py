...
class BaseTrainer:
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks=None):
        ...
        self.trainset_rgb, self.trainset_depth, self.testset_rgb, self.testset_depth = self.get_dataset(self.data)
        self.ema = None
        self.resume = False
    ...
    def get_dataset(data):
        ...
        """
        return data['train_rgb'], data['train_depth'], data.get('val_rgb') or data.get('test_rgb'), data.get('val_depth') or data.get('test_depth'),
    ...
    def build_dataset(self, dataset_path_rgb, dataset_path_depth, mode='train', batch=None):
        """Build dataset."""
